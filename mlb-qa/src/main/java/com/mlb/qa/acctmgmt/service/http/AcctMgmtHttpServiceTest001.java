...
public class AcctMgmtHttpServiceTest001 {
	...
	public HttpResult setCreditCardServiceSetPrimary(String CreditCardServiceSetPrimaryEndpointURL, String CreditCardServiceSetPrimarySoapAction, String CreditCardServiceSetPrimarySoapEnvelopePart1, String CreditCardServiceSetPrimarySoapEnvelopePart2, String CreditCardServiceSetPrimarySoapEnvelopePart3, String CreditCardServiceSetPrimarySoapEnvelopePart4, String CreditCardServiceSetPrimaryID, String CreditCardServiceSetPrimaryFingerprint, String CreditCardServiceSetPrimaryCardID) throws UnsupportedEncodingException {
		...
		HttpResult creditCardServiceSetPrimarySoapResponse = (postSoapRequest(CreditCardServiceSetPrimaryEndpointURL, CreditCardServiceSetPrimarySoapAction, CreditCardServiceSetPrimarySoapEnvelope));
		return(creditCardServiceSetPrimarySoapResponse);
	}
	
	public HttpResult setWalletServiceFindAll(String WalletServiceFindAllEndpointURL, String WalletServiceFindAllSoapAction, String WalletServiceFindAllSoapEnvelopePart1, String WalletServiceFindAllSoapEnvelopePart2, String WalletServiceFindAllSoapEnvelopePart3, String WalletServiceFindAllID, String WalletServiceFindAllFingerprint) throws UnsupportedEncodingException {
		...
		HttpResult walletServiceFindAllSoapResponse = (postSoapRequest(WalletServiceFindAllEndpointURL, WalletServiceFindAllSoapAction, WalletServiceFindAllSoapEnvelope));
		return(walletServiceFindAllSoapResponse);
	}
