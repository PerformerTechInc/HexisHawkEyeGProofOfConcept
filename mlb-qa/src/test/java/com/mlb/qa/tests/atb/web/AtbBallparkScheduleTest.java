...
public class AtbBallparkScheduleTest extends UITest {
	 ...
	 * 
	 * @Parameters({ "team_abbrev", "team_schedule_web" }) public void
	 * checkListSchedule(String teamAbbrev, String scheduleUrl) {
	 * List<ScheduleGameInfo> scheduleUi = AtbBallparkSchedulePage.open(driver,
	 * scheduleUrl).loadGamesFromListTab(); String year =
	 * AtbParameter.MLB_ATB_SEASON.getValue(); int month = new
	 * DateTime().getMonthOfYear(); Team team =
	 ...
	 * Integer.parseInt(year), month); Assert.assertTrue(0 == new
